...
$asunto       = "Lista de Confirmación de Evaluación"; 
$cuerpo =' 
<html> 
<head> 
<title>Lista de Confirmación de Evaluación</title>
</head> 
<body> 
<h2>Lista de Confirmación de Evaluación</h2>
<hr> 
<p> 
'.$_POST['contenido'].'
</p> 
...
header('Location: http://192.168.1.7/reserva/pages/detalle-lista-evaluacion?id='.$_POST['id'].'&m='.'ok');
}
